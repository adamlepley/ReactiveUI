...
namespace ReactiveUI
{
    ...
    {
        private static readonly MemoizingMRUCache<Type, Dictionary<string, bool>> persistablePropertiesCache = new MemoizingMRUCache<Type, Dictionary<string, bool>>((type, _) =>
        {
        ...
        private static readonly MemoizingMRUCache<Type, bool> dataContractCheckCache = new MemoizingMRUCache<Type, bool>((t, _) =>
        {
